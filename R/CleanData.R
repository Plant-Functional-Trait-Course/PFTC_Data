...
CleanColoradoTrait <- function(dat){
  dat2 <- dat %>% 
    select(year, site, elev, taxon_std, family, no_of_leaves, leaf_area, wet_mass, dry_mass, SLA, LDMC, WC, height_flower, height_leaf, height, height_2, thickness_1, thickness_2, thickness_3, thickness, pc_C, pc_N, pc_P, d13C, d15N,  C_N,  N_C,  N_P) %>% 
